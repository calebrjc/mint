...
int main(int argc, char **argv)
{
    ...
    // Lower the log level to WARN, so INFO/DEBUG/TRACE will not print
    MINT_LOGI("Setting log level to WARN (INFO/DEBUG/TRACE will be filtered)");
    mint_set_level(MINT_ID_GLOBAL, MINT_LEVEL_WARN);

    MINT_LOG("This should print (ALWAYS)");
    MINT_LOGN("This should print (NOTIFY)");
    MINT_LOGF("This should print (FATAL)");
    MINT_LOGE("This should print (ERROR)");
    MINT_LOGW("This should print (WARN)");
    MINT_LOGI("This should NOT print (INFO)");
    MINT_LOGD("This should NOT print (DEBUG)");
    MINT_LOGT("This should NOT print (TRACE)");

    // Restore log level to DEBUG for rest of tests
    mint_set_level(MINT_ID_GLOBAL, MINT_LEVEL_DEBUG);
